...
import jgraphx.editor.EditorActions.AlignCellsAction;
import jgraphx.editor.EditorActions.AutosizeAction;
import jgraphx.editor.EditorActions.BackgroundAction;
import jgraphx.editor.EditorActions.BackgroundImageAction;
import jgraphx.editor.EditorActions.ColorAction;
...
import jgraphx.editor.EditorActions.ImportAction;
import jgraphx.editor.EditorActions.KeyValueAction;
...
import jgraphx.editor.EditorActions.PromptValueAction;
...
import jgraphx.editor.EditorActions.SetLabelPositionAction;
import jgraphx.editor.EditorActions.SetStyleAction;
import jgraphx.editor.EditorActions.StyleAction;
import jgraphx.editor.EditorActions.StylesheetAction;
import jgraphx.editor.EditorActions.ToggleAction;
import jgraphx.editor.EditorActions.ToggleConnectModeAction;
import jgraphx.editor.EditorActions.ToggleCreateTargetItem;
...
public class EditorMenuBar extends JMenuBar
{
	...
	public EditorMenuBar(final BasicGraphEditor editor)
	{
		...
		menu.add(editor.bind(mxResources.get("new"), new NewAction(), "/jgraphx/images/new.gif"));
		menu.add(editor.bind(mxResources.get("openFile"), new OpenAction(), "/jgraphx/images/open.gif"));
		menu.add(editor.bind(mxResources.get("importStencil"), new ImportAction(), "/jgraphx/images/open.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("save"), new SaveAction(false), "/jgraphx/images/save.gif"));
		menu.add(editor.bind(mxResources.get("saveAs"), new SaveAction(true), "/jgraphx/images/saveas.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("pageSetup"), new PageSetupAction(), "/jgraphx/images/pagesetup.gif"));
		menu.add(editor.bind(mxResources.get("print"), new PrintAction(), "/jgraphx/images/print.gif"));
		...
		menu.add(editor.bind(mxResources.get("undo"), new HistoryAction(true), "/jgraphx/images/undo.gif"));
		menu.add(editor.bind(mxResources.get("redo"), new HistoryAction(false), "/jgraphx/images/redo.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("cut"), TransferHandler.getCutAction(), "/jgraphx/images/cut.gif"));
		menu.add(editor.bind(mxResources.get("copy"), TransferHandler.getCopyAction(), "/jgraphx/images/copy.gif"));
		menu.add(editor.bind(mxResources.get("paste"), TransferHandler.getPasteAction(), "/jgraphx/images/paste.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("delete"), mxGraphActions.getDeleteAction(), "/jgraphx/images/delete.gif"));
		...
		submenu.add(editor.bind(mxResources.get("basicStyle"),
				new StylesheetAction("/jgraphx/resources/basic-style.xml")));
	...
	{
		menu.add(editor.bind(mxResources.get("home"), mxGraphActions.getHomeAction(), "/jgraphx/images/house.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("exitGroup"), mxGraphActions.getExitGroupAction(), "/jgraphx/images/up.gif"));
		menu.add(editor.bind(mxResources.get("enterGroup"), mxGraphActions.getEnterGroupAction(),
				"/jgraphx/images/down.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("group"), mxGraphActions.getGroupAction(), "/jgraphx/images/group.gif"));
		menu.add(editor.bind(mxResources.get("ungroup"), mxGraphActions.getUngroupAction(),
				"/jgraphx/images/ungroup.gif"));
		...
		menu.add(editor.bind(mxResources.get("collapse"), mxGraphActions.getCollapseAction(),
				"/jgraphx/images/collapse.gif"));
		menu.add(editor.bind(mxResources.get("expand"), mxGraphActions.getExpandAction(), "/jgraphx/images/expand.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("toBack"), mxGraphActions.getToBackAction(), "/jgraphx/images/toback.gif"));
		menu.add(editor.bind(mxResources.get("toFront"), mxGraphActions.getToFrontAction(),
				"/jgraphx/images/tofront.gif"));
	...
	public static void populateFormatMenu(JMenu menu, BasicGraphEditor editor)
	{
		...
		submenu.add(editor.bind(mxResources.get("straight"), new SetStyleAction("straight"),
				"/jgraphx/images/straight.gif"));

		submenu.add(editor.bind(mxResources.get("horizontal"), new SetStyleAction(""), "/jgraphx/images/connect.gif"));
		submenu.add(editor.bind(mxResources.get("vertical"), new SetStyleAction("vertical"),
				"/jgraphx/images/vertical.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("entityRelation"), new SetStyleAction("edgeStyle=mxEdgeStyle.EntityRelation"),
				"/jgraphx/images/entity.gif"));
		submenu.add(editor.bind(mxResources.get("arrow"), new SetStyleAction("arrow"), "/jgraphx/images/arrow.gif"));
