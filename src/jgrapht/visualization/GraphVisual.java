...
public class GraphVisual {
    ...
    private void createGraphViz(DefaultDirectedGraph<String, DefaultEdge> graph) throws IOException {
    ...
    private void makeGraphImage() throws IOException {
        // 그림 출력하기
    ...
    public static void main(String[] args) {
        ...
        try {
            DefaultDirectedGraph<String, DefaultEdge> graph = gv.createGraph();
            gv.createGraphViz(graph);
            gv.makeGraphImage();
        } catch (IOException e) {
            e.printStackTrace();
        }
